      ...
      <div className="pb-9 lg:px-[4vw] lg:pb-12 xl:px-10vw">
        <div className="relative mx-auto grid lg:max-w-7xl">
          <Tab.Group
            ...
            className={clsx('w-full grid-cols-12 gap-x-8 overflow-visible', {
              grid: isDesktopScreen,
            })}
          >
            <Tab.List
              className={clsx(
            ...
            <Tab.Panels className="mt-4 lg:col-span-9 lg:mt-0">
              <Tab.Panel key={location.pathname} className="block">
                <AnimatePresence>
                  <motion.div
                  ...
                  >
                    <div className="relative h-full min-h-[50vh] w-full">
                      <div className="w-full border-b border-t border-gray-100 bg-black shadow-[1px_10px_47px_0px_#19191987] dark:border-gray-800 lg:-mt-16 lg:rounded-lg lg:border xl:-mt-20">
                        <Outlet />
                      </div>
                    </div>
                  </motion.div>
