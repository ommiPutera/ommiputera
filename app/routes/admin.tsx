                ...
                <AnimatePresence>
                  ...
                  >
                    <div className="relative h-full min-h-[50vh] w-full">
                      <div className="w-full border-b border-t border-gray-100 dark:border-gray-800 bg-black shadow-[1px_10px_47px_0px_#19191987] lg:-mt-16 lg:rounded-lg lg:border xl:-mt-20">
                        <Outlet />
                      </div>
                    </div>
                  </motion.div>
