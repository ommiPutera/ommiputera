      ...
      <div className="pb-9 lg:px-15vw lg:pb-12">
        <div className="relative mx-auto grid lg:max-w-8xl">
          ...
          >
            <TabList
              className={clsx(
                'flex gap-1.5 overflow-x-scroll bg-transparent px-5vw lg:col-span-3 lg:overflow-x-hidden lg:px-0',
                {
            ...
            >
              {LINKS.map(link => (
                <Link
                  ...
                  prefetch="intent"
                  className={clsx(
                    'z-10 rounded-md px-4 py-3.5 text-left text-md xl:text-lg font-medium text-gray-300',
                    {
