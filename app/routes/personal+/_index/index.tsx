...
function TabComponent({
  ...
  return (
    <Tab
      className={({ selected }) =>
        clsx(
          'font-medium relative flex w-full justify-center border-b-0 border-b-transparent py-3 hover:bg-gray-100/30 focus:outline-none dark:hover:bg-gray-800/40',
          {
