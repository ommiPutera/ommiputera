  ...
  return (
    <div className="mx-auto grid max-w-8xl gap-8 lg:gap-y-12">
      <div className="flex grid-cols-1 flex-col items-center justify-between gap-5 lg:grid lg:grid-cols-7 lg:flex-row lg:items-start lg:gap-x-48">
        ...
        <p className="col-span-1 mt-2 text-center text-lg font-medium text-gray-300 lg:col-span-3 lg:mt-3 lg:text-left lg:text-xl">
      ...
      <div className="mt-12 grid grid-cols-1 gap-x-12 gap-y-8 lg:grid-cols-12 lg:gap-y-0">
        ...
        <div className="col-span-1 h-96 rounded-lg border border-gray-700 lg:col-span-8 lg:-mr-32">
          Asset
        </div>
      </div>
      <div className="mt-12 grid grid-cols-1 gap-x-12 gap-y-8 lg:grid-cols-12 lg:gap-y-0">
