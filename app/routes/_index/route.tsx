...
function Certifed() {
  return (
    <div className="flex flex-col gap-14">
      <h3 className="text-center text-lg font-medium lg:text-4xl">
        Certified By
      </h3>
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-x-14 gap-y-8 overflow-hidden lg:gap-y-0">
        <img
          src="/purwadhika-logo.png"
          alt=""
          className="w-36 opacity-60 lg:w-52"
        />
        <img src="/udemy-logo.png" alt="" className="w-32 opacity-60 lg:w-36" />
        <img
          src="/hackerrank-logo.png"
          alt=""
          className="w-32 opacity-60 lg:w-44"
        />
        <img
