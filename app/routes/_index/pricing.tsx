...
function PricingCard({
  ...
  return (
    <div className="col-span-4 flex cursor-pointer flex-col rounded-xl border border-gray-100 dark:border-gray-800 px-10 py-12 hover:bg-gray-800 lg:gap-y-10">
