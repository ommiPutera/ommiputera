...
export default function Index() {
  ...
  return (
    <>
      ...
      />
      <div className="flex flex-col w-full mt-12 gap-y-6 max-w-3xl my-0 mx-auto items-center justify-between py-4">
        <Form
          className="w-full"
          method="post"
        >
          ...
          <input type="hidden" name="postId" value={postId ?? actionData?.post?.id} />
