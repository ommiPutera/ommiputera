      ...
      <div className="relative grid max-w-7xl grid-cols-1 md:grid-cols-4 lg:gap-x-4">
        {isPostsExist ? (
          posts?.map(post => (
            <div
              key={post.id}
              className="col-span-1 cursor-pointer rounded-lg border border-gray-800 bg-black p-4 hover:border-gray-800"
            >
...
function Guides() {
  ...
  if (!show) return <></>
  return (
    <div className="mb-4 flex items-center justify-between rounded-lg border border-gray-800 bg-black px-8 py-6">
      <div>
      ...
      <div className="flex items-center gap-x-4">
        <ButtonLink
          ...
          variant="subtle"
          to="/cash-flow/guides"
          className="flex items-center gap-x-2 border border-gray-800 bg-black"
        >
...
function NoData() {
  return (
    <div className="grid w-full gap-y-4 rounded-lg border border-gray-800 bg-black py-44 text-center">
