  ...
  return (
    <div className="bg-gradient-to-b from-black to-gray-900 pb-24">
      ...
      <div className="relative mx-auto lg:max-w-7xl">
        <AnimatePresence>
          <motion.div
            className="-mt-36 rounded-lg border border-gray-100 dark:border-gray-800 bg-black"
          ...
          >
            ...
            >
              <Tab.List className="z-0 flex mx-6 mt-4 overflow-x-scroll bg-transparent px-0 lg:col-span-3 lg:overflow-x-hidden">
