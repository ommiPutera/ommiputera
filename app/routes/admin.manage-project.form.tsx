...
function FormAction() {
  ...
  return (
    <>
      ...
      >
        <Dialog.Panel className="mx-4 flex w-full max-w-[100vw] flex-col gap-y-6 rounded-lg border border-gray-100 dark:border-gray-800 bg-black p-0 lg:mx-auto lg:max-w-[24vw]">
          <Form method="POST">
            <input type="hidden" name="projectId" value={project?.id || ''} />
