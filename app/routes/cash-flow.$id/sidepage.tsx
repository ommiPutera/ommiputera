...
export default function SidePage({
  ...
  return (
    <div className="flex h-full flex-col gap-y-4">
      <div className="rounded-lg border border-gray-100 bg-black px-3 py-3 dark:border-gray-800">
      ...
      <div className="sticky top-16">
        <div className="z-50 rounded-lg border border-gray-100 bg-black px-3 py-3 dark:border-gray-800">
