...
export const loader = async ({ request, params }: LoaderArgs) => {
  ...
  if (!id || !post) return redirect('/personal-finance')
...
export const action: ActionFunction = async ({ request }) => {
  ...
  switch (_action) {
    case FormType.DELETE: {
      ...
      return redirect('/personal-finance', {})
    }
  ...
  return (
    <WrapperOutlet>
      <OutletCenter>
        ...
        />
        <div className="mx-auto my-0 mt-6 w-full justify-between gap-x-8 px-6 pb-12">
