...
export function Header({
  ...
  return (
    <div className="sticky left-0 top-0 z-50 mx-auto flex max-h-[63px] w-full max-w-5xl justify-center border-gray-100 bg-white/[0.65] px-6 py-4 dark:border-gray-800 dark:bg-black/[0.65] backdrop-blur-md">
