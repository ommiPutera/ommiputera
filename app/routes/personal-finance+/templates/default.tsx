    ...
    <div className="m-6">
      ...
      >
        <Tab.List className="z-0 mx-auto">
          <div className="w-full flex gap-4 pr-6">
            <TabItem
              title="Bulanan"
              index={0}
              selectedIndex={selectedIndex}
...
function TabItem({
  ...
  return (
    <TabComponent index={index}>
      <div className="relative w-44 text-left flex flex-col gap-2 rounded-md px-6 py-4 bg-gray-100 dark:bg-gray-900">
        <Wallet strokeWidth={2.5} />
        <div>
          <h2 className="mt-0.5 text-lg font-semibold">{title}</h2>
          <p className="text-sm text-gray-400 font-normal">12 Templat</p>
        </div>
        <div
          className={clsx(
  ...
  return (
    <div className="flex flex-col gap-12">
      <div>
        ...
        <p className='text-md font-medium text-gray-400 dark:text-gray-200'>Build anything with thousands of templates</p>
      </div>
      <div>
        <h4 className="text-lg font-semibold mb-4">Yang disediakan</h4>
      ...
      <div>
        <h4 className="text-lg font-semibold mb-4">Dari Komunitas</h4>
        <div className="grid grid-cols-2 gap-4">
          <Card />
          <Card />
          <Card />
