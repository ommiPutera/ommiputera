...
export const action: ActionFunction = async ({request}) => {
  ...
  switch (loginType) {
    ...
    case 'register': {
      ...
      const user = await register({username, password, role: 'BASIC'})
      if (!user) {
        return {
          fields,
      ...
      return createUserSession({
        userId: user.id,
        redirectUrl: user.role === 'BASIC' ? '/cash-flow' : '/dashboard',
      })
    }
    default: {
...
export default function Index() {
  ...
  return (
    <main className="flex flex-col gap-5 pb-44 pt-8 lg:min-h-screen lg:gap-16 lg:pt-12">
      <div className="mx-auto px-10vw py-9 lg:py-10">
        <div className="flex w-[22rem] flex-col">
          <div className="mb-16 flex w-full flex-col gap-3">
            <Logo withoutUnderlined />
            <h1 className="mt-12 text-3xl font-medium leading-10 lg:text-4xl">
              ...
              >
                ...
                <div className="mb-3">
                  ...
                  {isPasswordValid && !loginFormIsValid ? (
                    <div
                      id="form-error-message"
                      className="mb-4 mt-2 flex items-center gap-x-3 rounded-md border border-gray-800 bg-gray-800 px-4 py-3 text-gray-200"
                    >
                      <div>
