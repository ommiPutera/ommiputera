...
function ProjectSection({
  ...
  return (
    <div className="relative mx-auto flex w-full max-w-8xl flex-col gap-5 py-4 lg:gap-y-16 lg:py-12">
      <img
        className="rounded-lg border border-gray-600 object-cover lg:mx-5vw"
        {...getImgProps(image, {
