...
import { createPost, deletePost, getPost, updateContent, updateTitle } from '~/utils/post.session'
    ...
    <>
      ...
      <div className="mx-auto my-0 mt-12 flex w-full max-w-3xl flex-col items-center justify-between gap-y-6 py-4">
        <Form method="POST" className='w-full' action='.'>
          ...
          <input type="hidden" name="_action" value={postId === 'new' ? FormType.CREATE : FormType.UPDATE_TITLE} />
        ...
        <Form method="POST" className='w-full'>
          ...
          <input type="hidden" name="_action" value={postId === 'new' ? FormType.CREATE : FormType.UPDATE_CONTENT} />
          <input type="hidden" name="authorId" value={user?.id} />
