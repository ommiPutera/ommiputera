...
function PageLoadingMessage() {
  ...
  return (
    <div className="fixed bottom-4 z-50 mx-4 flex w-11/12 flex-col justify-center rounded-lg border border-gray-700 bg-gray-800 px-8 py-4 md:w-4/5 lg:bottom-14 lg:right-14 lg:mx-0 lg:w-72">
