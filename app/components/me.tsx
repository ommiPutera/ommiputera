  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild className="cursor-pointer">
        <div className="ml-1 flex items-center gap-x-2 rounded-md bg-gray-600 px-3 py-1.5">
  ...
  return (
    <DropdownMenuContent className="">
      ...
      <DropdownMenuGroup className="p-1">
        <Link to="/me">
          <DropdownMenuItem className="flex w-full items-center justify-between gap-x-12 rounded-md border border-transparent px-2 hover:border-gray-800 hover:bg-gray-800">
