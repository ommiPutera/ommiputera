...
function DesktopNavLink({
  ...
  if (asParent && child?.length) {
    return (
      <NavigationMenuItem>
        <NavigationMenuTrigger className='w-full whitespace-nowrap text-lg font-medium focus:outline-none lg:tracking-wide text-secondary data-[state=open]:bg-gray-800 data-[state=open]:text-white'>
          {children}
        </NavigationMenuTrigger>
