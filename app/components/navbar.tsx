...
function DarkModeToggle({ variant = 'icon' }: { variant?: 'icon' | 'labelled' }) {
  ...
  return (
    <button
      ...
      className={clsx(
        'color-scheme-toggle',
        'focus:border-secondary inline-flex h-12 w-12 md:h-9 md:w-9 border-2 items-center justify-center overflow-hidden rounded-full p-1 transition hover:bg-gray-200 focus:outline-none hover:dark:bg-gray-800',
      )}
