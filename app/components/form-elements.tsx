...
export const inputClassName =
  'dark:disabled:text-slate-500 px-5 font-light tracking-wide w-full text-black disabled:text-gray-400 py-2.5 placeholder:text-md dark:text-white text-md bg-gray-100 dark:bg-transparent focus:border-transparent border border-gray-600 rounded-lg'
