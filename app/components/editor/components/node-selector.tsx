...
export const NodeSelector: FC<NodeSelectorProps> = ({
  ...
  return (
    <div className="relative h-full">
      ...
      {isOpen && (
        <section className="fixed top-full z-[99999] mt-1 flex w-48 flex-col overflow-hidden rounded border border-stone-200 p-1 shadow-xl animate-in fade-in slide-in-from-top-1">
