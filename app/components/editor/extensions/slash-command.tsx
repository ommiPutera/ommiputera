...
const CommandList = ({
  ...
  return items.length > 0 ? (
    <div
      ...
      className="z-50 h-auto max-h-[330px] w-72 overflow-y-auto rounded-md border border-stone-200 bg-gray-900 px-1 py-2 shadow-md transition-all"
    >
      {items.map((item: CommandItemProps, index: number) => {
        return (
          ...
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-md border border-stone-200 bg-gray-900">
