  ...
  return (
    <div className="text-primary relative mx-auto grid max-w-5xl gap-8 lg:gap-12">
      <div className="flex flex-col items-center justify-center gap-8">
        ...
        <h1 className="2xl:w-3/5 px-0 text-center text-4xl font-semibold md:w-2/3 lg:w-3/4 lg:text-7xl lg:leading-[4.5rem]">
          Helping brands and peoples through quality software.
        </h1>
        <p className="px-0 text-center text-lg font-normal text-gray-500 dark:text-gray-200 md:w-2/3 lg:px-9 lg:text-xl xl:w-3/5">
