  ...
  return (
    <div className="text-primary relative mx-auto grid max-w-5xl gap-8 lg:gap-12">
      <div className="flex flex-col items-center justify-center gap-6 md:gap-8">
        <button className="flex items-center gap-x-2 rounded-full border-2 border-gray-200 bg-gray-100 px-6 py-2 hover:border-black dark:border-gray-600 dark:bg-gray-800 dark:hover:border-gray-200">
          <Badge variant="orange" size="xs">New</Badge>
          <p className="text-sm font-medium">Open-Source Software</p>
          <ArrowRight size={16} />
        </button>
        <h1 className="2xl:w-3/5 px-0 text-center text-4xl leading-10 font-semibold md:w-2/3 lg:w-3/4 lg:text-7xl lg:leading-[4.5rem]">
    ...
    <div className="text-primary relative mx-auto grid max-w-5xl gap-8 lg:gap-12">
      <div className="flex flex-col items-center justify-center gap-6 md:gap-8">
        ...
        <button className="rounded-full border-2 border-gray-200 bg-gray-100 px-6 py-2 hover:border-black dark:border-gray-600 dark:bg-gray-800 dark:hover:border-gray-200">
          <p className="text-md font-semibold pt-0.5">Get Started</p>
        </button>
      </div>
    </div>
  )
