  ...
  return (
    <div className="text-primary relative mx-auto grid max-w-7xl gap-8 lg:gap-12">
      <div className="flex flex-col items-center justify-center gap-8">
        <button className="flex items-center gap-x-2 rounded-full bg-gray-100 border-2 border-gray-200 hover:border-black dark:border-gray-600 dark:hover:border-gray-200 dark:bg-gray-800 px-4 py-1.5">
        ...
        <p className="px-0 text-center leading-relaxed text-lg font-normal text-gray-500 dark:text-gray-200 md:w-2/3 lg:px-9 lg:text-xl xl:w-3/5">
