  ...
  return (
    <div>
      ...
      <div className="w-10 h-10 top-[var(--header-height-mobile)] md:top-[var(--header-height)] absolute overflow-hidden left-2.5 md:left-14">
        <div className="absolute top-0 left-0 w-14 h-12 border border-neutral-200 dark:border-neutral-800 rounded-tl-2xl shadow-circle"></div>
      </div>
      <div className="w-10 h-10 top-[var(--header-height-mobile)] md:top-[var(--header-height)] absolute overflow-hidden right-2.5 md:right-14">
        <div className="absolute top-0 right-0 w-14 h-12 border border-neutral-200 dark:border-neutral-800 rounded-tr-2xl shadow-circle"></div>
      </div>
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <div className="w-10 h-10 bottom-[var(--bottom-border-height-mobile)] md:bottom-[var(--bottom-border-height)] absolute overflow-hidden left-2.5 md:left-14">
        <div className="absolute bottom-0 left-0 w-14 h-12 border border-neutral-200 dark:border-neutral-800 rounded-bl-2xl shadow-circle"></div>
      </div>
      <div className="w-10 h-10 bottom-[var(--bottom-border-height-mobile)] md:bottom-[var(--bottom-border-height)] absolute overflow-hidden right-2.5 md:right-14">
        <div className="absolute bottom-0 right-0 w-14 h-12 border border-neutral-200 dark:border-neutral-800 rounded-br-2xl shadow-circle"></div>
      </div>
    </div>
  );
}
